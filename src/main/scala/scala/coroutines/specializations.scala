...
extends Coroutine._1[Short, S] {
  ...
  def $call(a0: Short): Coroutine.Inst[S]
  def $push(c: Coroutine.Inst[S], a0: Short): Unit
}
...
extends Coroutine._1[Char, S] {
  def apply(a0: Char): S
  def $call(a0: Char): Coroutine.Inst[S]
  def $push(c: Coroutine.Inst[S], a0: Char): Unit
}
...
extends Coroutine._1[Int, S] {
  def apply(a0: Int): S
  def $call(a0: Int): Coroutine.Inst[S]
  def $push(c: Coroutine.Inst[S], a0: Int): Unit
}
...
extends Coroutine._1[Float, S] {
  ...
  def $call(a0: Float): Coroutine.Inst[S]
  def $push(c: Coroutine.Inst[S], a0: Float): Unit
}
...
extends Coroutine._1[Long, S] {
  def apply(a0: Long): S
  def $call(a0: Long): Coroutine.Inst[S]
  def $push(c: Coroutine.Inst[S], a0: Long): Unit
}
...
extends Coroutine._1[Double, S] {
  ...
  def $call(a0: Double): Coroutine.Inst[S]
  def $push(c: Coroutine.Inst[S], a0: Double): Unit
}

abstract class _1$spec$L[T0, @specialized(Short, Char, Int, Float, Long, Double) S]
extends Coroutine._1[T0, S] {
  def apply(a0: T0): S
  def $call(a0: T0): Coroutine.Inst[S]
  def $push(c: Coroutine.Inst[S], a0: T0): Unit
}
